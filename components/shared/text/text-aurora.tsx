...
interface TextAuroraProps extends Omit<React.HTMLAttributes<HTMLElement>, keyof MotionProps> {
  className?: string
  children: React.ReactNode
  as?: React.ElementType
}

export const TextAurora: React.FC<TextAuroraProps> = ({
  className,
  children,
  as: Component = "span",
  ...props
...
TextAurora.displayName = "TextAurora"
